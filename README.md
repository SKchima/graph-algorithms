...
A Java library implementing classic graph algorithms with test coverage and performance benchmarks.

> [!NOTE]
> **Project Purpose**: This is a **recreational and educational library** focused on clean implementations of fundamental graph algorithms. Auxiliary tasks—such as documentation and testing—are automated via **AI assistants**, allowing the developer to focus on algorithmic logic.

## System Architecture

The library follows an **object-oriented design** with a focus on **extensibility** and **type safety**.
